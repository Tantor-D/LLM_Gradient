...
do
    ...
    # for TASK in "ASDiv" "GSM" "MultiArith" "SVAMP" "LeeTCode_code_high" "LeeTCode_code_medium" "LeeTCode_code_low" "olympic_OE_TO_maths_en_COMP" "olympic_OE_TO_physics_en_COMP" "olympic_TP_TO_maths_en_COMP" "olympic_TP_TO_physics_en_COMP"
    for TASK in "MultiArith" "SVAMP" "LeeTCode_code_high" "LeeTCode_code_medium" "LeeTCode_code_low"
    do
