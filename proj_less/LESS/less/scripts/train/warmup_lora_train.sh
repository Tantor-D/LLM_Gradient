...
train_files=("$data_dir/train/processed/code_high/code_high_data.jsonl"
    "$data_dir/train/processed/code_low/code_low_data.jsonl"
    "$data_dir/train/processed/code_medium/code_medium_data.jsonl")
