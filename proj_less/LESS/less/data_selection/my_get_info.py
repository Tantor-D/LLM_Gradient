...
from less.data_selection.my_collect_grads import collect_grads_of_special_layers
...
if args.task is not None:
    ...
    dataset = get_dataset(args.task,
                          ...
                          zh=args.zh,
                          sample_size=None,  # 这个可以调大，专门增加了这一部分的代码
...
# 确定是要收集梯度
assert args.info_type == "grads"

# 调用我的映射不同的层的梯度的函数
collect_grads_of_special_layers(
